...
public class AddType extends Frame{
    static AddType a = new AddType();
	public AddType(){
		...
		submit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				if(tTID.getText().equals("")){
					JOptionPane.showMessageDialog(null,"商标编号为空");
				}
