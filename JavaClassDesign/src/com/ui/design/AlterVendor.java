...
public class AlterVendor extends Frame{
	...
	public AlterVendor(){
		...
		submit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				n.updateVendor(Vphone.getText(), Vaddress.getText(),Vpostcode.getText(),Vdescription.getText(),Vname.getText());
	...
	public static void main(String[] args){
	    AlterVendor av= new AlterVendor();
		av.dispose();
	}
}
