...
public class OrderMessage extends Frame {
    ...
    short TID;
	String Vname;
	static OrderMessage ui = new OrderMessage();; 
	public OrderMessage(){     
		...
		p3 = new Panel();
		TIDName =  new Label("订单编号"); 
		tTID = new TextField(20);
		p3.add(TIDName);
		p3.add(tTID);
		select = new Button("查询所有订单");
		p3.add(select);
		add(p3);
